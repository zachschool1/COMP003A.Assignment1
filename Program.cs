namespace COMP003A.Assignment1
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("This is 100 things about me!");
            Console.WriteLine("#1 I am a father");
            Console.WriteLine("#2 I have two cats");
            Console.WriteLine("#3 I have two daughters");
            Console.WriteLine("#4 I bought a laptop for sale just for this class");
            Console.WriteLine("#5 My daughter broke my other laptop");
            Console.WriteLine("#6 My old laptop was almost 10 years old");
            Console.WriteLine("#7 I like JavaScript");
            Console.WriteLine("#8 I hope c# is a good language to learn");
